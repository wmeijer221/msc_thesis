...
python3 ./python_proj/data_preprocessing/sliding_window_2.py \
    -pd sorted_filtered_focal_to_other_complete_no_invalid,sorted_filtered_other_to_focal_sample_1_complete_no_invalid,sorted_other_to_focal_sample_2_complete_no_invalid,sorted_filtered_core_complete_no_invalid \
